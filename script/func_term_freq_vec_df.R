#' Create term frequency vector as data frame format
#'
#' This function converts term frequency vector TFV (generated by tm package) into TVF data frame
#' 
#' @param TFV a term frequency vector 
#' @param parallel option for parallel mode (TRUE) and not parallel mode (FALSE)
#' @param batch.mode option for creating smaller pieces of TFV data frame: using smaller batches (TRUE) and not using batches all in one run (FALSE)
#' @param batch.size number determining batch size for splitting TFV in batches
#' @return a term frequency vector in data frame format (for further usage)
